...
namespace Learn_Programming_Malayalam.Areas.Admin.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Email,Phone,Location,Company")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Email,Phone,Location,Company")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
